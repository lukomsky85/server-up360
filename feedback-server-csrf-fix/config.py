...
class DevelopmentConfig(Config):
    ...
    SESSION_COOKIE_SAMESITE = 'Lax'        # ✅ Lax — работает по HTTP, не блокирует куку
    SESSION_COOKIE_DOMAIN = None            # ✅ Текущий хост (не ограничивать)
    SESSION_COOKIE_PATH = '/'               # ✅ Доступно для всего сайта
    SESSION_COOKIE_NAME = 'feedback_session'  # ✅ Уникальное имя — не конфликтует с school_app
...
class ProductionConfig(Config):
    ...
    SESSION_COOKIE_PATH = '/'
    SESSION_COOKIE_NAME = 'feedback_session'  # ✅ Уникальное имя куки
